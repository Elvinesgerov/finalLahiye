...
ucbtn.addEventListener("click", ()=>{
    if (ucselect.value == "Rubl" && input.value >0){
        ...
        ucprize.innerHTML = "57.97"
        ucnumber.innerHTML = input.value
        amount.innerHTML = Math.floor(input.value * 57.97)
...
ucbtn1.addEventListener("click", ()=>{
    if (ucselect1.value == "Rubl" && input1.value >0){
        ...
        ucprize1.innerHTML = "225.01"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 225.01)
        ...
        ucprize1.innerHTML = "2.48"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 2.48)
        hiddenuc1.style.display = "block"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        ucprize1.innerHTML = "4.23"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 4.23)
        hiddenuc1.style.display = "block"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
...
ucbtn2.addEventListener("click", ()=>{
    if (ucselect2.value == "Rubl" && input2.value >0){
        ...
        ucprize2.innerHTML = "430.31"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 430.31)
        hiddenuc1.style.display = "none"
        ...
        ucprize2.style.marginLeft = "42px"
        ...
        ucprize2.innerHTML = "4.75"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 4.75)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "block"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        ucprize2.innerHTML = "8.09"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 8.09)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "block"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
...
ucbtn3.addEventListener("click", ()=>{
    if (ucselect3.value == "Rubl" && input3.value >0){
        uctd3.innerHTML = "1850"
        ucvalyuta3.innerHTML = "Rubl"
        ucprize3.innerHTML = "798.40"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 798.40)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        ...
        uctd3.innerHTML = "1850"
        ucvalyuta2.innerHTML = "Usd"
        ucprize2.innerHTML = "8.82"
        ucnumber2.innerHTML = input3.value
        amount2.innerHTML = Math.floor(input3.value * 8.82)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
        ...
        nametd3.style.marginLeft = "25px"
        uctd3.style.marginLeft = "5px"
        ucnumber3.style.marginLeft = "45px"
        ...
        ucprize3.innerHTML = "15.01"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 15.01)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
...
ucbtn4.addEventListener("click", ()=>{
    if (ucselect4.value == "Rubl" && input4.value >0){
        uctd4.innerHTML = "3400"
        ucvalyuta4.innerHTML = "Rubl"
        ucprize4.innerHTML = "1.368.08"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 1.369)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        ...
        uctd4.style.marginLeft = "-2px"
        ucnumber4.style.marginLeft = "40px"
        ...
        ucprize4.innerHTML = "15.12"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 15.12)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
        ...
        ucnumber4.style.marginLeft = "42px"
        ...
        ucprize4.innerHTML = "25.72"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 25.72)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
...
ucbtn5.addEventListener("click", ()=>{
    if (ucselect5.value == "Rubl" && input5.value >0){
        uctd5.innerHTML = "5550"
        ucvalyuta5.innerHTML = "Rubl"
        ucprize5.innerHTML = "2.110.10"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 2.111)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        uctd5.style.marginLeft = "-2px"
        ucnumber5.style.marginLeft = "40px"
        ucvalyuta5.style.marginLeft = "30px"
        ucprize5.style.marginLeft = "42px"
        ...
        ucprize5.innerHTML = "23.33"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 23.33)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        ucnumber5.style.marginLeft = "42px"
        ...
        ucprize5.innerHTML = "39.67"
        ucnumber5.innerHTML = input4.value
        amount5.innerHTML = Math.floor(input5.value * 39.67)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
