...
ucbtn.addEventListener("click", ()=>{
    if (ucselect.value == "Rubl" && input.value >0){
        ...
        ucprize.innerHTML = "58.75"
        ucnumber.innerHTML = input.value
        amount.innerHTML = Math.floor(input.value * 58.75)
        ...
        nametd.style.marginLeft = "15px"
        uctd.style.marginLeft = "-15px"
        ucnumber.style.marginLeft = "54px"
        ...
        ucprize.innerHTML = "0.65"
        ucnumber.innerHTML = input.value
        amount.innerHTML = Math.floor(input.value * 1.65)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        nametd.style.marginLeft = "10px"
        uctd.style.marginLeft = "-10px"
...
ucbtn1.addEventListener("click", ()=>{
    if (ucselect1.value == "Rubl" && input1.value >0){
        uctd1.innerHTML = "1800"
        ucvalyuta1.innerHTML = "Rubl"
        ucprize1.innerHTML = "113.82"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 113.82)
        ...
        nametd1.style.marginLeft = "15px"
        uctd1.style.marginLeft = "-15px"
        ucnumber1.style.marginLeft = "54px"
        ...
        ucprize1.innerHTML = "1.25"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 1.25)
        hiddenuc1.style.display = "block"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        nametd1.style.marginLeft = "10px"
        uctd1.style.marginLeft = "-10px"
        ucnumber1.style.marginLeft = "57px"
        ...
        ucprize1.innerHTML = "2.14"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 2.14)
        hiddenuc1.style.display = "block"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        nametd1.style.marginLeft = "10px"
        uctd1.style.marginLeft = "-10px"
        ucnumber1.style.marginLeft = "70px"
        ucvalyuta1.style.marginLeft = "45px"
...
ucbtn2.addEventListener("click", ()=>{
    if (ucselect2.value == "Rubl" && input2.value >0){
        ...
        nametd2.style.marginLeft = "10px"
        uctd2.style.marginLeft = "-15px"
        ucnumber2.style.marginLeft = "54px"
        ucvalyuta2.style.marginLeft = "28px"
        ...
        nametd2.style.marginLeft = "10px"
        uctd2.style.marginLeft = "-13px"
        ucnumber2.style.marginLeft = "50px"
        ucvalyuta2.style.marginLeft = "30px"
...
ucbtn3.addEventListener("click", ()=>{
    if (ucselect3.value == "Rubl" && input3.value >0){
        uctd3.innerHTML = "10400"
        ucvalyuta3.innerHTML = "Rubl"
        ucprize3.innerHTML = "571.80"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 571.80)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        ...
        nametd3.style.marginLeft = "10px"
        uctd3.style.marginLeft = "-15px"
        ucnumber3.style.marginLeft = "50px"
        ucvalyuta3.style.marginLeft = "20px"
        ucprize3.style.marginLeft = "42px"
        ...
        uctd3.innerHTML = "10400"
        ucvalyuta2.innerHTML = "Usd"
        ucprize2.innerHTML = "6.32"
        ucnumber2.innerHTML = input3.value
        amount2.innerHTML = Math.floor(input3.value * 6.32)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
        ...
        ucprize3.innerHTML = "10.75"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 10.75)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
        ...
        nametd3.style.marginLeft = "10px"
        uctd3.style.marginLeft = "-20px"
        ucnumber3.style.marginLeft = "55px"
        ucvalyuta3.style.marginLeft = "30px"
...
ucbtn4.addEventListener("click", ()=>{
    if (ucselect4.value == "Rubl" && input4.value >0){
        uctd4.innerHTML = "20.000"
        ucvalyuta4.innerHTML = "Rubl"
        ucprize4.innerHTML = "1097"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 1907)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        ...
        nametd4.style.marginLeft = "5px"
        uctd4.style.marginLeft = "-18px"
        ucnumber4.style.marginLeft = "60px"
        ucvalyuta4.style.marginLeft = "20px"
        ucprize4.style.marginLeft = "53px"
        ...
        ucprize4.innerHTML = "12.14"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 12.14)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
        ...
        nametd4.style.marginLeft = "10px"
        uctd4.style.marginLeft = "-23px"
        ucnumber4.style.marginLeft = "55px"
        ucvalyuta4.style.marginLeft = "25px"
        ...
        ucprize4.innerHTML = "20.64"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 20.64)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
        ...
        nametd4.style.marginLeft = "10px"
        uctd4.style.marginLeft = "-20px"
        ucnumber4.style.marginLeft = "48px"
        ucvalyuta4.style.marginLeft = "30px"
        ucprize4.style.marginLeft = "55px"
...
ucbtn5.addEventListener("click", ()=>{
    if (ucselect5.value == "Rubl" && input5.value >0){
        uctd5.innerHTML = "21.000"
        ucvalyuta5.innerHTML = "Rubl"
        ucprize5.innerHTML = "1276"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 1276)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        nametd5.style.marginLeft = "5px"
        uctd5.style.marginLeft = "-18px"
        ucnumber5.style.marginLeft = "60px"
        ucvalyuta5.style.marginLeft = "20px"
        ucprize5.style.marginLeft = "53px"
        ...
        ucprize5.innerHTML = "14.11"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 14.11)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        nametd5.style.marginLeft = "10px"
        uctd5.style.marginLeft = "-23px"
        ucnumber5.style.marginLeft = "55px"
        ucvalyuta5.style.marginLeft = "25px"
        ucprize5.style.marginLeft = "55px"
        ...
        ucprize5.innerHTML = "23.99"
        ucnumber5.innerHTML = input4.value
        amount5.innerHTML = Math.floor(input5.value * 23.99)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
