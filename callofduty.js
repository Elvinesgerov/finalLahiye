...
ucbtn.addEventListener("click", ()=>{
    if (ucselect.value == "Rubl" && input.value >0){
        ...
        nametd.style.marginLeft = "30px"
        uctd.style.marginLeft = "43px"
        ucnumber.style.marginLeft = "60px"
        ...
        nametd.style.marginLeft = "32px"
        uctd.style.marginLeft = "39px"
        ucnumber.style.marginLeft = "70px"
...
ucbtn1.addEventListener("click", ()=>{
    if (ucselect1.value == "Rubl" && input1.value >0){
        ...
        nametd1.style.marginLeft = "30px"
        uctd1.style.marginLeft = "43px"
        ucnumber1.style.marginLeft = "55px"
        ucvalyuta1.style.marginLeft = "30px"
        ...
        nametd1.style.marginLeft = "32px"
        uctd1.style.marginLeft = "39px"
        ucnumber1.style.marginLeft = "63px"
        ucvalyuta1.style.marginLeft = "35px"
...
ucbtn2.addEventListener("click", ()=>{
    if (ucselect2.value == "Rubl" && input2.value >0){
        ...
        nametd2.style.marginLeft = "32px"
        uctd2.style.marginLeft = "39px"
        ucnumber2.style.marginLeft = "55px"
        ucvalyuta2.style.marginLeft = "35px"
...
ucbtn3.addEventListener("click", ()=>{
    if (ucselect3.value == "Rubl" && input3.value >0){
        ...
        nametd3.style.marginLeft = "32px"
        uctd3.style.marginLeft = "22px"
        ucnumber3.style.marginLeft = "55px"
        ucvalyuta3.style.marginLeft = "35px"
        ucprize3.style.marginLeft = "45px"
        ...
        nametd3.style.marginLeft = "32px"
        uctd3.style.marginLeft = "22px"
        ucnumber3.style.marginLeft = "62px"
        ucvalyuta3.style.marginLeft = "35px"
        ucprize3.style.marginLeft = "45px"
...
ucbtn4.addEventListener("click", ()=>{
    if (ucselect4.value == "Rubl" && input4.value >0){
        ...
        nametd4.style.marginLeft = "32px"
        uctd4.style.marginLeft = "17px"
        ucnumber4.style.marginLeft = "60px"
        ucvalyuta4.style.marginLeft = "30px"
        ucprize4.style.marginLeft = "52px"
...
ucbtn5.addEventListener("click", ()=>{
    if (ucselect5.value == "Rubl" && input5.value >0){
        ...
        nametd5.style.marginLeft = "32px"
        uctd5.style.marginLeft = "12px"
