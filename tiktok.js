...
ucbtn.addEventListener("click", ()=>{
    if (ucselect.value == "Rubl" && input.value >0){
        ...
        ucprize.innerHTML = "414.89"
        ucnumber.innerHTML = input.value
        amount.innerHTML = Math.floor(input.value * 414.89)
        ...
        ucprize.innerHTML = "4.58"
        ucnumber.innerHTML = input.value
        amount.innerHTML = Math.floor(input.value * 4.58)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
...
ucbtn1.addEventListener("click", ()=>{
    if (ucselect1.value == "Rubl" && input1.value >0){
        ...
        ucprize1.innerHTML = "776.06"
        ucnumber1.innerHTML = input1.value
        amount1.innerHTML = Math.floor(input1.value * 776.06)
        ...
        uctd1.style.marginLeft = "37px"
        ucnumber1.style.marginLeft = "50px"
        ucprize1.style.marginLeft = "46px"
        ...
        nametd1.style.marginLeft = "25px"
        uctd1.style.marginLeft = "37px"
        ucnumber1.style.marginLeft = "60px"
        ...
        nametd1.style.marginLeft = "25px"
        uctd1.style.marginLeft = "37px"
        ucnumber1.style.marginLeft = "63px"
...
ucbtn2.addEventListener("click", ()=>{
    if (ucselect2.value == "Rubl" && input2.value >0){
        ...
        ucprize2.innerHTML = "1.022.87"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 1.023)
        hiddenuc1.style.display = "none"
        ...
        uctd2.style.marginLeft = "37px"
        ucnumber2.style.marginLeft = "33px"
        ucprize2.style.marginLeft = "46px"
        ucvalyuta2.style.marginLeft = "55px"
        ...
        ucprize2.innerHTML = "11.31"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 11.31)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "block"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        ucprize2.style.marginLeft = "65px"
        ucvalyuta2.style.marginLeft = "55px"
        ...
        ucprize2.innerHTML = "19.23"
        ucnumber2.innerHTML = input2.value
        amount2.innerHTML = Math.floor(input2.value * 19.23)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "block"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
...
ucbtn3.addEventListener("click", ()=>{
    if (ucselect3.value == "Rubl" && input3.value >0){
        uctd3.innerHTML = "1321"
        ucvalyuta3.innerHTML = "Rubl"
        ucprize3.innerHTML = "1.460.63"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 1.461)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        ...
        uctd3.style.marginLeft = "33px"
        ucnumber3.style.marginLeft = "30px"
        ucprize3.style.marginLeft = "50px"
        ucvalyuta3.style.marginLeft = "45px"
        ...
        uctd3.innerHTML = "1321"
        ucvalyuta2.innerHTML = "Usd"
        ucprize2.innerHTML = "16.15"
        ucnumber2.innerHTML = input3.value
        amount2.innerHTML = Math.floor(input3.value * 16.15)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
        ...
        ucprize3.innerHTML = "27.46"
        ucnumber3.innerHTML = input3.value
        amount3.innerHTML = Math.floor(input3.value * 27.46)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "block"
        hiddenuc4.style.display = "none"
        ...
        nametd3.style.marginLeft = "25px"
        uctd3.style.marginLeft = "33px"
        ucnumber3.style.marginLeft = "65px"
        ucprize3.style.marginLeft = "50px"
        ucvalyuta3.style.marginLeft = "45px"
...
ucbtn4.addEventListener("click", ()=>{
    if (ucselect4.value == "Rubl" && input4.value >0){
        uctd4.innerHTML = "1400"
        ucvalyuta4.innerHTML = "Rubl"
        ucprize4.innerHTML = "2.098.93"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 2.099)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        ...
        hiddenuc5.style.display = "none"
        hiddenuc.style.display = "none"
        nametd4.style.marginLeft = "28px"
        uctd4.style.marginLeft = "33px"
        ucnumber4.style.marginLeft = "39px"
        ucprize4.style.marginLeft = "42px"
        ucvalyuta4.style.marginLeft = "45px"
        ...
        ucprize4.innerHTML = "23.21"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 23.21)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
        ...
        nametd4.style.marginLeft = "28px"
        uctd4.style.marginLeft = "33px"
        ucnumber4.style.marginLeft = "57px"
        ...
        ucprize4.innerHTML = "39.46"
        ucnumber4.innerHTML = input4.value
        amount4.innerHTML = Math.floor(input4.value * 39.46)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "block"
...
ucbtn5.addEventListener("click", ()=>{
    if (ucselect5.value == "Rubl" && input5.value >0){
        uctd5.innerHTML = "3500"
        ucvalyuta5.innerHTML = "Rubl"
        ucprize5.innerHTML = "3.175.53"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 3.176)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        hiddenuc.style.display = "none"
        nametd5.style.marginLeft = "28px"
        uctd5.style.marginLeft = "33px"
        ucnumber5.style.marginLeft = "32px"
        ucprize5.style.marginLeft = "45px"
        ucvalyuta5.style.marginLeft = "45px"
        ...
        ucprize5.innerHTML = "35.11"
        ucnumber5.innerHTML = input5.value
        amount5.innerHTML = Math.floor(input5.value * 35.11)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
        ...
        ucprize5.innerHTML = "59.70"
        ucnumber5.innerHTML = input4.value
        amount5.innerHTML = Math.floor(input5.value * 59.70)
        hiddenuc1.style.display = "none"
        hiddenuc2.style.display = "none"
        hiddenuc3.style.display = "none"
        hiddenuc4.style.display = "none"
